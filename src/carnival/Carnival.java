 ...
 public class Carnival {
	...
	public static void main(String[] args) {
		...
		System.out.println("Luis won: " + luis.showPrizes());
                ...
                System.out.println("Shonda has " + shonda.getMoney());
                System.out.println("and has won " + shonda.showPrizes());
                System.out.println("Luis has " + luis.getMoney());
                System.out.println("and has won " + luis.showPrizes());
